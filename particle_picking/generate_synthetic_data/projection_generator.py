...
def launch_parallel_process(thread_idx):
	...
	for i in tqdm(range(0,num_per_proc)):
		...
		r1, r2, r3 = 90+int(local_random_state.normal()*5),90+int(local_random_state.random_sample()*5),int(local_random_state.random_sample()*360)
		r4, r5, r6 = local_random_state.normal(0, 20), local_random_state.normal(0, 20), local_random_state.normal(0, 20)
		t = Transform()
