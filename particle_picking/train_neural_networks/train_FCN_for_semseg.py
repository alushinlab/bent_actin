...
folder = '/data01/greg/matt/neural_network_training_sets/'
noise_folder = folder + 'multiple_filaments_noise_2/'
noNoise_folder = folder + 'multiple_filaments_noNoise_2/'
...
model_path = '../train_neural_network/800000training_CCC9887.h5'
...
model_save_name = './FCN_semantic_segmentation_4.h5'
