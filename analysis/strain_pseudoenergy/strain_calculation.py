...
import string
################################################################################
#straight_file_name = './rigidFit_helical/7subunits_bentADP_initialRigidFit_HIS.pdb'
#straight_file_name = './isoldePhenix_final/7subunits_bent1ADP_Pi_initialRigidFit.pdb'
straight_file_name = './rigidFit_helical/7subunits_str3ADP_initialRigidFit_HIS.pdb'
#bent_file_name = './isoldePhenix_final/bentADP_hires_final_HIS.pdb'
bent_file_name = './isoldePhenix_final/str3ADP_hires_final_HIS.pdb'

output_file_name = 'shearStrain_ADP_str3.pdb'
#output_file_name = 'shearStrain_ADP_Pi.pdb'
#output_file_name = 'shearStrain_str1.pdb'
#output_file_name = 'shearStrain_str3.pdb'
...
straight = straight.reshape(2597,3)
bent = bent.reshape(2597,3)
...
shear_energies = shear_energies.reshape(7,371)
